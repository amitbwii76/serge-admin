...
//header('Cache-Control: max-age=900');
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add Company <button type="button" class="btn btn-info">All Companies</button></h1> 
     <!-- <nav>
        <ol class="breadcrumb">
              ...
              <form method="post" action="<?php echo base_url('admin/updatecompany'); ?>" enctype="multipart/form-data" name="addblog" id="addblog">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    <img src="<?php echo base_url();?>/upload/company/<?php echo $result['image']; ?>" height="50px" width="50px" >
                  </div>
                </div>
