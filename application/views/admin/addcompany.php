...
header('Cache-Control: max-age=900');
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add Company  <a href="<?php echo base_url('admin/allcompanies'); ?>" class="btn btn-info">All Companies</a></h1> 
     <!-- <nav>
        <ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <?php 
         /*File Validation message ( if image uploaded successfully) */ 
              ...
              <form method="post" action="<?php echo base_url('admin/addcompany'); ?>" enctype="multipart/form-data" name="addblog" id="addblog">
